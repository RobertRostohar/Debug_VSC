...
#define MX_ETH_COL_GPIO_Speed                   GPIO_SPEED_FREQ_VERY_HIGH
...
#define MX_ETH_CRS_GPIO_Speed                   GPIO_SPEED_FREQ_VERY_HIGH
...
/* ETH_RXD2 */
#define MX_ETH_RXD2_Pin                         PH6
#define MX_ETH_RXD2_GPIO_Pin                    GPIO_PIN_6
#define MX_ETH_RXD2_GPIOx                       GPIOH
#define MX_ETH_RXD2_GPIO_Mode                   GPIO_MODE_AF_PP
#define MX_ETH_RXD2_GPIO_PuPd                   GPIO_NOPULL
#define MX_ETH_RXD2_GPIO_Speed                  GPIO_SPEED_FREQ_VERY_HIGH
#define MX_ETH_RXD2_GPIO_AF                     GPIO_AF11_ETH

/* ETH_RXD3 */
#define MX_ETH_RXD3_Pin                         PH7
#define MX_ETH_RXD3_GPIO_Pin                    GPIO_PIN_7
#define MX_ETH_RXD3_GPIOx                       GPIOH
#define MX_ETH_RXD3_GPIO_Mode                   GPIO_MODE_AF_PP
#define MX_ETH_RXD3_GPIO_PuPd                   GPIO_NOPULL
#define MX_ETH_RXD3_GPIO_Speed                  GPIO_SPEED_FREQ_VERY_HIGH
...
#define MX_ETH_RX_CLK_GPIO_Speed                GPIO_SPEED_FREQ_VERY_HIGH
...
#define MX_ETH_RX_DV_GPIO_Speed                 GPIO_SPEED_FREQ_VERY_HIGH
...
#define MX_ETH_TXD2_GPIO_Speed                  GPIO_SPEED_FREQ_VERY_HIGH
...
#define MX_ETH_TXD3_GPIO_Speed                  GPIO_SPEED_FREQ_VERY_HIGH
...
#define MX_ETH_TX_CLK_GPIO_Speed                GPIO_SPEED_FREQ_VERY_HIGH
